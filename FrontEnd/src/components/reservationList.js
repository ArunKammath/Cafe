...
function ReservationList() {
    ...
    useEffect(() => {
        async function fetchReservations() {
            try {
                const res = await axios.post(`${process.env.REACT_APP_BACKEND_URL}/reserveList`, {userId: userData.userId});
    ...
    const handleDelete = async () => {
        ...
        const res = await axios.post(`${process.env.REACT_APP_BACKEND_URL}/ReservationList`, selectedRow);
